...
<form action="add.php" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      <label for="resp_cnpj">Resp. da Empresa (Pessoa Júridica)</label>
      <input type="text" class="form-control" name="customer['resp_cnpj']">
    </div>
    <div class="form-group col-md-3">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <input type="tel" class="form-control" name="customer['mobile']">
    </div>
    ...
    <div class="form-group col-md-2">
      <label for="campo3">Inscrição Estadual (PJ)</label>
