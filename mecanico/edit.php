...
<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      <label for="resp_cnpj">Resp. da Empresa (PF)</label>
      <input type="text" class="form-control" name="customer['resp_cnpj']" value="<?=$customer['resp_cnpj']?>">
    </div>
    <div class="form-group col-md-3">
